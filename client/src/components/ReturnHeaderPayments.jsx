import '../css/components/ReturnHeaderPayments.css'

export function ReturnHeaderPayments({ title, returnFunction }) {
    return (
        <header className="returnHeaderPayments-container">
            <div onClick={()=>{returnFunction()}}>
                <svg className='returnHeaderPayments-icon' width="11" height="18" viewBox="0 0 11 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 16L2 9L9 2" stroke="currentColor" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
            </div>
            <p className='returnHeaderPayments-title'>
                {title}
            </p>
            <div>
                <svg className='returnHeaderPayments-icon' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
