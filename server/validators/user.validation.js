...
exports.newUserValidation = () => {
    return [
        body('id_tarjeta').isNumeric().withMessage("El id de la tarjeta debe ser un numero"),
        ...
        body('telefono').notEmpty().isNumeric().withMessage('El numero de telefono no es valido')
    ];
};